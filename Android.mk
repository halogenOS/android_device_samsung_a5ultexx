...
MLD_SYMLINKS := $(addprefix $(TARGET_OUT_VENDOR)/firmware/,$(notdir $(MLD_IMAGES)))
...
$(shell mkdir -p $(TARGET_OUT_VENDOR)/firmware/wcd9306; \
    ln -sf /data/misc/audio/wcd9320_anc.bin \
    $(TARGET_OUT_VENDOR)/firmware/wcd9306/wcd9306_anc.bin; \
    ln -sf /data/misc/audio/mbhc.bin \
    $(TARGET_OUT_VENDOR)/firmware/wcd9306/wcd9306_mbhc.bin)
